# filesystem-observation Specification

## Purpose
Define Starglass's generic filesystem source family. Filesystem observation should watch files and directories through normalized observed state, compact diffing, and honest text-versus-binary handling without becoming an archival or workflow system.
## Requirements
